...
$metadata[$idpEntityId] = [
  ...
  'SingleSignOnService' => [
    [
      ...
      'Location' => $idpBaseURL . (getenv('SIMPLESAMLPHP_IDP_HTTP_POST_BINDING') ?: $fallbackBinding),
    ],
    [
      'Binding' => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect',
      'Location' => $idpBaseURL . (getenv('SIMPLESAMLPHP_IDP_HTTP_REDIRECT_BINDING') ?: $fallbackBinding),
    ],
    [
      'Binding' => 'urn:oasis:names:tc:SAML:2.0:bindings:SOAP',
      'Location' => $idpBaseURL . (getenv('SIMPLESAMLPHP_IDP_SOAP_BINDING') ?: $fallbackBinding),
    ],
    [
      'Binding' => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Artifact',
      'Location' => $idpBaseURL . (getenv('SIMPLESAMLPHP_IDP_HTTP_ARTIFACT') ?: $fallbackBinding),
    ],
  ],
  'SingleLogoutService' => [
    [
