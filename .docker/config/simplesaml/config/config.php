...
$config = [
     ...
     * reverse proxy).
     */
    'baseurlpath' => getenv('LAGOON_ROUTE') . '/' . getenv('LAGOON_PROJECT') . '-saml/',
    ...
    */
     ...
     */
    'auth.adminpassword' => getenv('GOVCMS_SIMPLESAML_PASS') ?: 'govcms@sso',
     ...
     */
    'database.username' => getenv('MARIADB_USERNAME') ?: 'drupal',
    'database.password' => getenv('MARIADB_PASSWORD') ?: 'drupal',
    'database.options' => [],
     ...
     * is shown.
     */
    'frontpage.redirect' => getenv('LAGOON_ROUTE') . '/system/404',
     ...
     */
    'metadatadir' => getenv('SIMPLESAMLPHP_METADATA_DIR') ?: '/app/config/saml/simplesaml/metadata',
     ...
     */
    'store.sql.username' => getenv('MARIADB_USERNAME') ?: 'drupal',
    'store.sql.password' => getenv('MARIADB_PASSWORD') ?: 'drupal',
